        ...
        <Layout className={styles.admin}>
          ...
          <Layout>
            <Header style={{ position: 'relative', background: 'midnightblue', padding: 0, height: '70px' }}>
              ...
              <p style={{ position: 'absolute', left: '1020px', top: '0px', fontWeight: 'bolder', fontSize: '12px', color: '#c9c9c9', lineHeight: '70px' }}>你好，<Icon type="smile" theme="twoTone"></Icon> {this.state.name} <Icon type="heart" theme="twoTone" twoToneColor="#eb2f96" /></p>
              <Popconfirm
                title="确定退出吗？"
                onConfirm={() => {
              ...
              >
                ...
                <button onClick={() => { this.changes() }} style={{ border: 'none', position: 'absolute', left: '1140px', top: '0', fontWeight: 'bolder', fontSize: '12px', background: 'midnightblue', height: '100%', display: 'block', float: 'right', color: '#c9c9c9' }}><Icon type="close-circle" /> <span>退出登录</span></button>
              </Popconfirm>
            </Header>
            <Content
              style={{
