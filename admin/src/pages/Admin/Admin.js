      ...
      <Layout className={styles.admin}>
        ...
        <Layout>
          <Header style={{ position: 'relative', background: 'midnightblue', padding: 0, height: '70px' }}>
            ...
            <h2 className={styles.h2} style={{ width: '400px', marginLeft: '500px', display: 'block', color: '#f9f9f9' }}>学生信息后台系统管理平台</h2>
            <Icon className="trigger" />
            <p style={{ position: 'absolute', left: '1000px', top: '0px', fontWeight: 'bolder', fontSize: '14px', color: '#c9c9c9', lineHeight: '70px' }}>你好，<Icon type="smile" theme="twoTone"></Icon> {this.state.name} <Icon type="heart" theme="twoTone" twoToneColor="#eb2f96" /></p>
            ...
            >
              ...
              <button onClick={() => { this.changes() }} style={{ border: 'none', position: 'absolute', left: '1140px', top: '0', fontWeight: 'bolder', fontSize: '14px', background: 'midnightblue', height: '100%', color: '#c9c9c9' }}><Icon type="logout" /> <span>退出登录</span></button>
            </Popconfirm>
